...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        ...
        speak("i am virtual assistant ,created by vansh Sir")
        ...
        window.open("%windir%\system32\calc.exe:")
    }
    else if(message.includes("open vscode")){
        speak("opening vscode..")
        window.open("C:\Users\Unique\AppData\Local\Programs\Microsoft VS Code\code.exe")
    }
...
function openLocalhost() {
    window.open("microsoft-edge:http://localhost:5500", "_blank");
}
